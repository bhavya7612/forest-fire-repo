...
class mongodbconnection:
    # This class shall be used for mongoDB operation6
    def __init__(self, username, password):
        try:
            self.username = username
            self.password = password
            self.url = f"mongodb+srv://{self.username}:{self.password}@cluster0.xhjnfgx.mongodb.net/?retryWrites=true&w=majority"
